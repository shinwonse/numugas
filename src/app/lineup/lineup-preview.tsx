      ...
      <div className="w-full max-w-[450px]">
        <Card className="overflow-hidden p-0 bg-slate-900 w-full aspect-[9/16]">
          <div className="flex h-full">
              ...
              {playerImage ? (
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-cyan-600">
                      LINEUP
                    </h3>
                  </div>
                </div>
            ...
            {/* 우측 영역 - 라인업 리스트 */}
            <div className="w-[45%] bg-black/80 p-3 sm:p-4 md:p-5 flex flex-col justify-center">
              <div className="space-y-1 sm:space-y-1.5 md:space-y-2">
                {lineup.map((player, index) => (
                  ...
                  >
                    ...
                    <span className="text-white font-bold text-sm sm:text-base md:text-lg flex-1 truncate text-right">
                      {player.name || '선수 이름'}
                    </span>
                  </div>
                ))}
