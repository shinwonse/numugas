...
export function LineupPreview({ lineup }: LineupPreviewProps) {
  return (
      ...
      <div className="w-full max-w-[450px]">
        <Card className="overflow-hidden p-0 bg-slate-900 w-full aspect-[9/16]">
          <div className="flex h-full">
            {/* 좌측 영역 - 선수 이미지 영역 */}
            <div className="flex-1 bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center p-4 sm:p-6">
