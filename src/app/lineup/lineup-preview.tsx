      ...
      <div className="w-full">
        <Card className="overflow-hidden p-0 w-full aspect-[9/16] relative">
          <div className="flex h-full">
            ...
            <div className="flex flex-1">
              ...
              <div className="flex-1 bg-gray-300 relative overflow-hidden">
                ...
                {playerImage ? (
                  ...
                  >
                    <TransformComponent
                      wrapperClass="!w-full !h-full absolute inset-0 z-10"
              ...
              {/* 우측 영역 - 라인업 리스트 */}
              <div className="w-[40%] bg-black/30 p-4 sm:p-5 md:p-6 flex flex-col mt-10">
                {/* 팀 로고 */}
            ...
            {/* 하단 띠 영역 */}
            <div className="absolute bottom-10 left-0 right-0 z-20 gap-4 flex flex-col">
              {/* 첫 번째 띠 */}
