...
const newsItems = [
  {
    ...
    date: '2023년 8월 10일',
    excerpt:
      '레드 드래곤즈의 에이스 김태훈 선수가 이번 시즌 최고의 투수로 선정되었습니다.',
  ...
  },
  {
    ...
    date: '2023년 8월 5일',
    excerpt:
      '레드 드래곤즈가 현재 8연승을 기록하며 리그 선두를 달리고 있습니다.',
    image: '/placeholder.svg?height=300&width=500',
  },
  {
    id: 3,
    ...
    date: '2023년 7월 28일',
    excerpt:
      '신인 선수 이민우가 프로 데뷔 후 첫 홈런을 기록하며 팀 승리에 기여했습니다.',
    image: '/placeholder.svg?height=300&width=500',
  },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {newsItems.map((news, index) => (
            <motion.div
              ...
              className="bg-black/60 rounded-lg overflow-hidden group hover:shadow-lg hover:shadow-red-400/20 transition-all duration-300"
            >
              ...
              <div className="p-6">
                ...
                <Button
                  variant="link"
                  className="p-0 text-red-500 hover:text-red-400 flex items-center gap-2"
                >
